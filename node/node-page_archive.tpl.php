...
*/?>
<!--______________NODE TPL POUR PAGE ARCHIVE.TPL CUSTOM________________ -->
<div class="node <?php print $classes; ?>" id="node-<?php print $node->nid; ?>">
    <div class="node-inner">
        <!--______________COLONNE 1________________ -->
        <div id="colonne-1" class="col1_layout_3_6_3 vdl_liste page-archive">
        ...
        <!--______________COLONNE 2________________ -->
                 <div id="colonne-2" class="col2_layout_3_6_3 vdl_liste page-archive">
        ...
        <div id="colonne-3" class="col3_layout_3_6_3 vdl_liste page-archive">
