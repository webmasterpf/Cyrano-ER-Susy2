...
function cyranod6_susy2_er_preprocess_node(&$vars, $hook) {
...
?>
<?php
function cyranod6_susy2_er_preprocess_page(&$vars){
...
// permet usage de vieilles versions de jQuery
    ...
    //drupal_add_js(drupal_get_path('theme', 'cyranod6_susy2_er') . '/js/jquery_plugin/shapes-polyfill.min.js', 'theme');
  drupal_add_js(drupal_get_path('theme', 'cyranod6_susy2_er') . '/js/jquery_plugin/shapes-polyfill.js', 'theme');
// permet usage de vieilles versions de jQuery
        //drupal_add_js(drupal_get_path('theme', 'cyranod6_susy2_er') . '/js/jquery-migrate-1.2.1.min.js', 'theme');
//chargement des plugins qui utilisent la version de jQuery par défaut du site
//   drupal_add_js(drupal_get_path('theme', 'cyranod6_susy2_er') . '/js/responsive-nav.js','theme');
//   drupal_add_js(drupal_get_path('theme', 'cyranod6_susy2_er') . '/js/tinynav.min.js','theme');
    //   drupal_add_js(drupal_get_path('theme', 'cyranod6_susy2_er') . '/js/jquery.navobile.min.js','theme');
    //   drupal_add_js(drupal_get_path('theme', 'cyranod6_susy2_er') . '/js/jquery.jpanelmenu.min.js','theme');
    drupal_add_js(drupal_get_path('theme', 'cyranod6_susy2_er') . '/js/jquery_plugin/selectnav.min.js', 'theme');
    drupal_add_js(drupal_get_path('theme', 'cyranod6_susy2_er') . '/js/jquery_plugin/jquery.sticky.js', 'theme');
  //  drupal_add_js(drupal_get_path('theme', 'cyranod6_susy2_er') . '/js/jquery.sidebar.min.js', 'theme');

//chargement des scripts qui utilisent la version de jQuery par défaut du site
    drupal_add_js(drupal_get_path('theme', 'cyranod6_susy2_er') . '/js/js_jquery_defaut.js', 'theme');
// mise en place du noConflict pour utiliser plusieurs versions de jQuery   
    drupal_add_js(drupal_get_path('theme', 'cyranod6_susy2_er') . '/js/jquery_init.js', 'theme');
//chargement des plugins qui utilisent une version de jQuery plus récente
    drupal_add_js(drupal_get_path('theme', 'cyranod6_susy2_er') . '/js/jquery_plugin/jquery.flexslider.js', 'theme');
    drupal_add_js(drupal_get_path('theme', 'cyranod6_susy2_er') . '/js/jquery_plugin/jquery.bxslider.min.js', 'theme');
    drupal_add_js(drupal_get_path('theme', 'cyranod6_susy2_er') . '/js/jquery_plugin/stacktable.min.js', 'theme');
    //drupal_add_js(drupal_get_path('theme', 'cyranod6_susy2_er') . '/js/jquery_plugin/wookmark.min.js', 'theme');
    drupal_add_js(drupal_get_path('theme', 'cyranod6_susy2_er') . '/js/jquery_plugin/jquery.masonry.min.js', 'theme');
    //drupal_add_js(drupal_get_path('theme', 'cyranod6_susy2_er') . '/js/jquery_plugin/ninja-slider/ninja-slider.js', 'theme');
    //drupal_add_js(drupal_get_path('theme', 'cyranod6_susy2_er') . '/js/jquery_plugin/ninja-slider/thumbnail-slider.js', 'theme');
    //drupal_add_js(drupal_get_path('theme', 'cyranod6_susy2_er') . '/js/jquery_plugin/slick/slick.min.js', 'theme');
    //drupal_add_js(drupal_get_path('theme', 'cyranod6_susy2_er') . '/js/jquery_plugin/chocolat/jquery.chocolat.min.js', 'theme');
    drupal_add_js(drupal_get_path('theme', 'cyranod6_susy2_er') . '/js/jquery_plugin/baguettebox/baguetteBox.min.js', 'theme');
    //drupal_add_js(drupal_get_path('theme', 'cyranod6_susy2_er') . '/js/jquery_plugin/salvattore.min.js', 'theme');
    //drupal_add_js(drupal_get_path('theme', 'cyranod6_susy2_er') . '/js/jquery_plugin/salvattore.js', 'theme');
    //drupal_add_js(drupal_get_path('theme', 'cyranod6_susy2_er') . '/3rdparty/buttons/js/buttons.js', 'theme');
    drupal_add_js(drupal_get_path('theme', 'cyranod6_susy2_er') . '/js/jquery_plugin/responsiveslides/responsiveslides.min.js', 'theme');
    
    
    //*** Utilisation des plugins Jquery  plus récents - Toujours terminer avec ce JS***
     drupal_add_js(drupal_get_path('theme', 'cyranod6_susy2_er') . '/js/js_jquery_new.js', 'theme');
    
    //  mise à disposition des 2 versions de jQuery
    drupal_add_js(drupal_get_path('theme', 'cyranod6_susy2_er') . '/js/jquery_exit.js', 'theme');
...
function cyranod6_susy2_er_webform_view_messages($node, $teaser, $page, $submission_count, $limit_exceeded, $allowed_roles, $closed, $cached) {
...
function cyranod6_susy2_er_filefield_file($file) {
...
function cyranod6_susy2_er_more_link ($url, $title) {
